...
ClangSharpPInvokeGenerator -l mdk -n MDK.SDK.NET.Gen -f .\global.h -o ..\..\..\csharp_gen\global.cs
...
ClangSharpPInvokeGenerator -l mdk -n MDK.SDK.NET.Gen -f .\Player.h -o ..\..\..\csharp_gen\Player.cs
